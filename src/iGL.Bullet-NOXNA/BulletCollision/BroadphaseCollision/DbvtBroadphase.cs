        ...
        public static void Benchmark(IBroadphaseInterface broadphaseInterface)
        {
            ...
            for (int iexp = 0; iexp < s_experiments.Length; ++iexp)
            {
                ...
                for (int i = 0; i < object_count; ++i)
                {
                    ...
                    po.proxy = broadphaseInterface.CreateProxy(po.center - po.extents, po.center + po.extents, BroadphaseNativeType.BoxShape, po, CollisionFilterGroups.DefaultFilter, CollisionFilterGroups.DefaultFilter, null, null);
                    objects.Add(po);
