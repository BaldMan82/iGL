...
namespace BulletXNA.BulletCollision
{
	...
	if(BulletGlobals.g_streamWriter != null && BulletGlobals.debugBroadphase)
	{
        ...
        public virtual BroadphaseProxy CreateProxy(Vector3 aabbMin, Vector3 aabbMax, BroadphaseNativeType shapeType, Object userPtr, CollisionFilterGroups collisionFilterGroup, CollisionFilterGroups collisionFilterMask, IDispatcher dispatcher, Object multiSapProxy)
        {
        ...
        public virtual BroadphaseProxy CreateProxy(ref Vector3 aabbMin, ref Vector3 aabbMax, BroadphaseNativeType shapeType, Object userPtr, CollisionFilterGroups collisionFilterGroup, CollisionFilterGroups collisionFilterMask, IDispatcher dispatcher, Object multiSapProxy)
        {
    ...
    public class SimpleBroadphaseProxy : BroadphaseProxy
    {
        ...
        public SimpleBroadphaseProxy(int position, ref Vector3 minpt, ref Vector3 maxpt, BroadphaseNativeType shapeType, Object userPtr, CollisionFilterGroups collisionFilterGroup, CollisionFilterGroups collisionFilterMask, Object multiSapProxy)
