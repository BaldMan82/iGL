...
namespace BulletXNA.BulletCollision
{
	public class Box2dBox2dCollisionAlgorithm : ActivatingCollisionAlgorithm
	{
		...
		public override void ProcessCollision(CollisionObject body0, CollisionObject body1, DispatcherInfo dispatchInfo, ManifoldResult resultOut)
		{
			...
			Box2dShape box0 = (Box2dShape)col0.CollisionShape;
			Box2dShape box1 = (Box2dShape)col1.CollisionShape;
		...
		//#define btCrossS(a,s) Vector3(s * a.getY(), -s * a.getX(),0.f)

		public static Vector3 CrossS(ref Vector3 a, float s)
		{
			return new Vector3(s*a.Y,-s * a.X,0);
		}
