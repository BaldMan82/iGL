...
namespace BulletXNA.BulletDynamics
{
	public class SliderConstraint : TypedConstraint
	{
		...
		public SliderConstraint(RigidBody rbA, RigidBody rbB, ref Matrix frameInA, ref Matrix frameInB, bool useLinearReferenceFrameA)
			: base(TypedConstraintType.Slider, rbA, rbB)
		{
			m_frameInA = frameInA;
			m_frameInB = frameInB;
		...
		public SliderConstraint(RigidBody rbB, ref Matrix frameInB, bool useLinearReferenceFrameA)
			: base(TypedConstraintType.Slider, GetFixedBody(), rbB)
		{
			m_frameInB = frameInB;
		...
		{
			GetInfo2NonVirtual(info, m_rbA.GetCenterOfMassTransform(), m_rbB.GetCenterOfMassTransform(), m_rbA.LinearVelocity, m_rbB.LinearVelocity, m_rbA.GetInvMass(), m_rbB.GetInvMass());
		}
		...
		public void GetInfo2NonVirtual(ConstraintInfo2 info, Matrix transA, Matrix transB, Vector3 linVelA, Vector3 linVelB, float rbAinvMass, float rbBinvMass)
		{
            ...
            Vector3 ax1A = trA._basis.GetColumn(0);
            Vector3 ax1B = trB._basis.GetColumn(0);
		...
		public void TestAngLimits()
		{
			...
			{
                Vector3 axisA0 = m_calculatedTransformA._basis.GetColumn(1);
                Vector3 axisA1 = m_calculatedTransformA._basis.GetColumn(2);
                Vector3 axisB0 = m_calculatedTransformB._basis.GetColumn(1);
