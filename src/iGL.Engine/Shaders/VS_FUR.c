...
uniform highp vec3 u_linearVelocity;
...
void main() 
{
	vec3 extrude = a_position + (a_normal)*u_shellIndex ;
		
	gl_Position =  u_modelViewProjectionMatrix * vec4(extrude.x*0.5f,extrude.y*0.5f, extrude.z*0.5f, 1);			
