...
namespace iGL.TestGame
{
    public class SpaceScene : Scene
    {
        ...
        public override void Load()
        {
            ...
            world.AddComponent(new RigidBodyComponent(mass: 1000, isStatic: true));

            AddGameObject(world);

            var world2 = new Sphere(5.0f, 32, 32);
            world2.Position = new Vector3(10, 15, 0);
            world2.Material.Diffuse = new Vector4(0.5f, 0.5f, 0.5f, 1);
            world2.AddComponent(new SphereColliderComponent());

            world2.AddComponent(new RigidBodyComponent(mass: 500, isStatic: true));
            ...
            world3.AddComponent(new RigidBodyComponent(mass: 500, isStatic: true));
